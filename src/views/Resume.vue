      ...
      <div class="bg-white shadow-xl rounded grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-3">
        ...
        <div class="row-span-1 col-span-1 space-y-4 pt-20 bg-gradient-to-b from-green-100 to-blue-100 dark:from-gray-200 dark:to-gray-400">
          ...
          <div class="flex flex-col justify-start items-center pb-8">
            <div>
              <img class="inline-block w-52 h-52 xl:h-64 xl:w-64 rounded-full ring-2 ring-white object-cover mb-4" src="../assets/kevin.jpg" alt="Kevin">
            </div>
            <div>
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><h4 class="text-sm lg:text-base text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">kevobuya@gmail.com</h4></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 pt-8 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><a href="https://twitter.com/odhiambokev11" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">Twitter</a></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><i class="fab fa-linkedin text-lg"></i></div>
              <div><a href="https://www.linkedin.com/in/kevin-obuya-685450161" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">LinkedIn</a></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><i class="fab fa-github text-lg"></i></div>
              <div><a href="https://github.com/kevin-411" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">Github</a></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><i class="fab fa-user-hoodie text-lg"></i></div>
              <div><a href="https://hackerone.com/klot?type=user" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">HackerOne</a></div>
            </div>
          </div>
...
export default {
  ...
  data(){
    return{
      experiences:[
        {name: 'Software Developer', date: 'Aug, 2024 – Jul, 2025', company: 'Sybrin'},
        {name: 'Implementation and Support Engineer', date: 'Sep, 2022 – Jul, 2024', company: 'Sybrin'},
        {name: 'Support Specialist', date: 'Sep, 2021 – Aug, 2022', company: 'Sybrin'},
        {name: 'Freelance Security Researcher', date: 'Mar, 2019 – Sep, 2021', company: 'HackerOne'},
        {name: 'Software Developer Intern', date: 'Jan, 2019 – Sep, 2020', company: 'Systech Limited'},
      ],
      formations:[
        {name: 'AWS Certified Cloud Practitioner Certification', date: '2025', school: 'eMobilis / Ajira Digital'},
        {name: 'Certified Ethical Hacker Course (CEH)', date: '2024', school: 'Strathmore University'},
        {name: 'MSc. Software Engineering', date: '2024-2026', school: 'Jomo Kenyatta University of Science and Technology'},
        {name: 'Intermediate Certificate in Data Science', date: '2023', school: 'Strathmore University'},
        {name: 'Bachelor in Computer Technology', date: '2014-2018', school: 'Jomo Kenyatta University of Science and Technology'},
      ],
      languages:[
